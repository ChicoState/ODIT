...
class AddReviewForm(forms.Form):
    ...
    def save(self, writer, subject):
        ...
        subject_instance = models.Profile.objects.get(
            user=review_instance.subject
        )
        ...
        subject_instance.rating_avg = round(
            subject_instance.rating_sum / subject_instance.rating_count,
            1
        )
